        ...
        <form id="{{ $formId ?? $id . '_form' }}" class="w-100 d-flex flex-column" style="height: 100%;">
            <div class="modal-content d-flex flex-column" style="height: 100%;">
                ...
                <div class="modal-body p-0 flex-grow-1" style="min-height: 0;">
                    <div class="w-100 h-100 d-flex flex-column flex-lg-row" id="{{ $id }}_split" style="min-height: 0; min-width: 0; overflow-x: hidden; --pane-left: 25%; --pane-mid: 50%; --pane-right: 25%;">
                        ...
                        <div class="p-4 border-end h-100" data-pane="middle" style="overflow-y:auto; overflow-x:hidden; min-height: 0; min-width: 0; flex: 0 0 calc(var(--pane-mid) - 16px);">
                            {{ $middle }}
                        </div>
