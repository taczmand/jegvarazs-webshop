            ...
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    <div class="header__top__left">
                        <ul>
                            <li><i class="fa fa-envelope"></i> info@jegvarazsbolt.hu</li>
                            <li>Ingyenes kiszállítás minden termékünkre!</li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6">
        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                <div class="header__cart">
                    ...
                    <div class="header__cart__price">összesen: <span>3 250 Ft</span></div>
                </div>
            </div>
        </div>
