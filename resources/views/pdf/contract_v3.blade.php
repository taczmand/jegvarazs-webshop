...
<div class="section">
    ...
    <div class="pont">
        @php
            ...
            $due_date = '<b style="border-bottom: 1px dotted black">────</b> év <b style="border-bottom: 1px dotted black">────────</b> hónap <b style="border-bottom: 1px dotted black">────</b> nap';
        ...
        <b style="display: inline-block; border-bottom: 1px dotted #000;">b*, {{ $transfer_amount }} Ft</b> azaz <b style="display: inline-block; border-bottom: 1px dotted #000;">{{ $transfer_amount_text }}</b> forint foglaló jogcímen a <b>11745035-26769143</b> számlaszámra kerül átutalásra. A szerződés a foglaló jóváírásának
    ...
    <div class="pont">
        @php
            ...
            $due_date = '<b style="border-bottom: 1px dotted black">────</b> év <b style="border-bottom: 1px dotted black">────────</b> hónap <b style="border-bottom: 1px dotted black">────</b> napjáig';
        ...
        <b style="border-bottom: 1px dotted black">b*, {{ $transfer_amount }} Ft</b> azaz <b style="border-bottom: 1px dotted black">{{ $transfer_amount_text }}</b> forint a munka elvégzésével kerül átutalásra a <b>11745035-26769143</b> ({!! $due_date !!})
        számlaszámra.
    </div>
...
<div class="contact-section">
    <h3>Iroda: 06-20/433-1949</h3>
    <h3>Email: jegvarazsiroda@gmail.com</h3>
</div>
...
<div class="section page-break">
    ...
    <div class="pont">
        <span class="szam">2.</span> a <b>foglaló <b style="border-bottom: 1px dotted black">{!! $transfer_amount !!}</b> Ft mely</b> átutalásra kerül a ({!! $due_date !!}) <b>11745035-26769143</b> számlaszámra. A kialkudott határidőre történő
