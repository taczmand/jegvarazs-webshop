...
@section('content')
    ...
    <div class="container p-0">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3 pb-2">
            <h2 class="color-dark-blue mb-0">Tartalomkezelés / Letöltések</h2>
        ...
        <div class="rounded-xl bg-white shadow-lg p-4">
            ...
            @else
                <div class="alert alert-warning" role="alert">
                    <i class="fa-solid fa-exclamation-triangle me-2"></i> Nincs jogosultságod a letöltések megtekintésére.
                </div>
            @endif
        </div>
    </div>
