...
<div class="container">
    ...
    <p>Ez egy emlékeztető az Ön által lefoglalt időpontról. Kérjük, ellenőrizze az alábbi adatokat.</p>
    ...
    <div class="details">
        ...
        @if(!empty($appointment->appointment_time))
            <p><strong>Időpont:</strong> {{ $appointment->appointment_time }}</p>
        @endif
        <p><strong>Helyszín:</strong> {{ $appointment->zip_code }} {{ $appointment->city }}, {{ $appointment->address_line }}</p>

        <hr>
        <p>Amennyiben az időpont nem megfelelő, vagy változtatni szeretne rajta, kérjük vegye fel velünk a kapcsolatot az alábbi elérhetőségeken.</p>
