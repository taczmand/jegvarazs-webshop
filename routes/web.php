...
//Route::middleware([Incognito::class])->group(function () {
    ...
    Route::prefix('admin')->name('admin.')->group(function () {
        ...
        Route::middleware(['admin.auth', 'ensure.monthly_vehicle_km'])->group(function () {
            ...
            Route::get('/termekek/{id}/stocks/data', [AdminProductController::class, 'stocksData'])->name('products.stocks.data');
            ...
            Route::post('/munkalapok/clientid-fix/apply', [WorksheetController::class, 'clientIdFixApply'])->name('worksheets.clientid-fix.apply');
