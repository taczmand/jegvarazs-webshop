...
class PermissionSeeder extends Seeder
{
    public function run(): void
    {
        $permissions = [
            ...
            ['id' => 35, 'name' => 'view-downloads', 'label' => 'Letöltések megtekintése', 'group' => 'Webshop'],
            ['id' => 36, 'name' => 'edit-download', 'label' => 'Letöltés szerkesztése', 'group' => 'Webshop'],
            ['id' => 37, 'name' => 'create-download', 'label' => 'Letöltés létrehozása', 'group' => 'Webshop'],
            ['id' => 38, 'name' => 'delete-download', 'label' => 'Letöltés törlése', 'group' => 'Webshop'],
            ['id' => 39, 'name' => 'view-regulations', 'label' => 'Szabályzatok megtekintése', 'group' => 'Webshop'],
            ['id' => 40, 'name' => 'create-regulation', 'label' => 'Szabályzat létrehozása', 'group' => 'Webshop'],
            ['id' => 41, 'name' => 'edit-regulation', 'label' => 'Szabályzat szerkesztése', 'group' => 'Webshop'],
            ['id' => 42, 'name' => 'delete-regulation', 'label' => 'Szabályzat törlése', 'group' => 'Webshop'],
