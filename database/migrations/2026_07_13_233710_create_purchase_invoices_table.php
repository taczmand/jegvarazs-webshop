...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('purchase_invoices', function (Blueprint $table) {
            ...
            $table->string('status')->default('draft')->comment('Számla állapota (pl. draft, booked, cancelled)');
            ...
            $table->string('transaction_id')->nullable()->comment('Tranzakció azonosító');
            ...
            $table->foreignId('related_goods_receipt_id')->nullable()->constrained('goods_receipts')->nullOnDelete()->cascadeOnUpdate()->comment('Kapcsolódó bevételezés azonosító (goods_receipts.id)');
            $table->foreignId('storno_of_purchase_invoice_id')->nullable()->constrained('purchase_invoices')->nullOnDelete()->cascadeOnUpdate()->comment('Stornó esetén az eredeti bejövő számla azonosítója');

            $table->string('external_provider')->nullable()->comment('Külső szolgáltató neve');
        ...
        Schema::create('purchase_invoice_items', function (Blueprint $table) {
            ...
            $table->foreignId('purchase_invoice_id')->constrained('purchase_invoices')->cascadeOnDelete()->cascadeOnUpdate()->comment('Bejövő számla azonosító');
